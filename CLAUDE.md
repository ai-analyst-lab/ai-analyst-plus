...
| Independent Review | `.claude/skills/independent-review/skill.md` | Invoked as `/independent-review` — provider-neutral blind second-pass validation. Dispatches a fresh subagent blind to the original SQL/numbers to independently re-derive the result. Reports AGREE/PARTIAL/DISAGREE per finding. Preferred over `/codex-review` unless Codex is specifically wanted. Audit trail in `.knowledge/independent-review/` |
